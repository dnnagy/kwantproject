...
\begin{figure}
  ...
  \begin{minipage}{0.333\textwidth}
      \centering
      \includegraphics[width=1.5\textwidth]{./media/2degconst_W4_L10.png} % first figure itself
      %\caption{first figure}
  \end{minipage}\hfill
  \begin{minipage}{0.333\textwidth}
      \centering
      \includegraphics[width=1.6\textwidth]{./media/2degconst_W5_L10.png} % second figure itself
      %\caption{second figure}
  \end{minipage}\hfill
  \begin{minipage}{0.333\textwidth}
    \centering
    \includegraphics[width=1.6\textwidth]{./media/2degconst_W8_L10.png} % third figure itself
...
\begin{figure}
  ...
  \begin{minipage}{0.333\textwidth}
      \centering
      \includegraphics[width=1.0\textwidth]{./media/cond_2deg_W4_L10_VL4_0_VS4_0.png} % first figure itself
      %\caption{first figure}
  \end{minipage}\hfill
  \begin{minipage}{0.333\textwidth}
      \centering
      \includegraphics[width=1.0\textwidth]{./media/cond_2deg_W5_L10_VL4_0_VS4_0.png} % second figure itself
      %\caption{second figure}
  \end{minipage}\hfill
  \begin{minipage}{0.333\textwidth}
    \centering
    \includegraphics[width=1.0\textwidth]{./media/cond_2deg_W8_L10_VL4_0_VS4_0.png} % third figure itself
    %\caption{third figure}
  \end{minipage}
...
\begin{figure}
  ...
  \begin{minipage}{0.333\textwidth}
      \centering
      \includegraphics[width=1.0\textwidth]{./media/cond_2deg_W4_L10_VL6_0_VS6_0.png} % first figure itself
      %\caption{first figure}
  \end{minipage}\hfill
  \begin{minipage}{0.333\textwidth}
      \centering
      \includegraphics[width=1.0\textwidth]{./media/cond_2deg_W5_L10_VL6_0_VS6_0.png} % second figure itself
      %\caption{second figure}
  \end{minipage}\hfill
  \begin{minipage}{0.333\textwidth}
    \centering
    \includegraphics[width=1.0\textwidth]{./media/cond_2deg_W8_L10_VL6_0_VS6_0.png} % third figure itself
    %\caption{third figure}
  \end{minipage}
...
\begin{figure}
  ...
  \begin{minipage}{0.333\textwidth}
      \centering
      \includegraphics[width=1.0\textwidth]{./media/shotnoise_2deg_W4_L10_VL4_0_VS4_0.png} % first figure itself
      %\caption{first figure}
  \end{minipage}\hfill
  \begin{minipage}{0.333\textwidth}
      \centering
      \includegraphics[width=1.0\textwidth]{./media/shotnoise_2deg_W5_L10_VL4_0_VS4_0.png} % second figure itself
      %\caption{second figure}
  \end{minipage}\hfill
  \begin{minipage}{0.333\textwidth}
    \centering
    \includegraphics[width=1.0\textwidth]{./media/shotnoise_2deg_W8_L10_VL4_0_VS4_0.png} % third figure itself
    %\caption{third figure}
  \end{minipage}
...
\begin{figure}
  ...
  \begin{minipage}{0.333\textwidth}
      \centering
      \includegraphics[width=1.0\textwidth]{./media/shotnoise_2deg_W4_L10_VL6_0_VS6_0.png} % first figure itself
      %\caption{first figure}
  \end{minipage}\hfill
  \begin{minipage}{0.333\textwidth}
      \centering
      \includegraphics[width=1.0\textwidth]{./media/shotnoise_2deg_W5_L10_VL6_0_VS6_0.png} % second figure itself
      %\caption{second figure}
  \end{minipage}\hfill
  \begin{minipage}{0.333\textwidth}
    \centering
    \includegraphics[width=1.0\textwidth]{./media/shotnoise_2deg_W8_L10_VL6_0_VS6_0.png} % third figure itself
    %\caption{third figure}
  \end{minipage}
